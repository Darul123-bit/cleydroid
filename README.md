...
**[Emylda]** is an independent operating system built for mobile devices. Designed to offer a lightweight, smooth,and privacy-focused alternative to mainstream mobile plateforms, it is built entirely on open technologies.
